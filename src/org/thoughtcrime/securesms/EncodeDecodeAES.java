...
public class EncodeDecodeAES {
    ...
    public  EncodeDecodeAES(Context context) {
        this.context = context;
    }
   //  */
    private final static String HEX = "0123456789ABCDEF";
    private final static int JELLY_BEAN_4_2 = 17;
    private final static byte[] key = { 'F', 'e', 'n', 'i', 'x', 'D', 'a','M', 'a', 't', 'r','i', 'x', 'c', 'r', 'i' };
...
/*
       //------------CRIPTUS---------------
        ...
        String password = "Marcelo24";
        String Seeds = "jcunion";
        String passwordEnc = null;
        String passwordDecs = null;

        try {
             passwordEnc = myCrip.encrypt(Seeds,password);
        } catch (Exception e) {
            e.printStackTrace();
        }

        try {
             passwordDecs = EncodeDecodeAES.decrypt(Seeds,passwordEnc);
        } catch (Exception e) {
            e.printStackTrace();
        }
        passwordDecs = passwordDecs + "#";
        //------------CRIPTUS---------------
